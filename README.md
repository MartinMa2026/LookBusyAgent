...
- **💨 纯净无痛，随时待命**：如果你不懂 Python，直接去 [GitHub Releases](https://github.com/MartinMa2026/LookBusyAgent/releases) 下载单体 `.exe` 或 zip 包，双击就能跑，无任何流氓弹窗和多余残留。
...
3. 填入你自己的 LLM API Key（如果嫌麻烦不填，它也会用内置的弱智降级废话模板撑场面；项目默认已不再内置任何 API Key）。
